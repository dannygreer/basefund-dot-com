    ...
    <div className="min-h-screen bg-light-gray flex flex-col md:flex-row">
      ...
      <div className="md:flex-1 p-6 md:p-12 flex flex-col justify-center text-white relative order-1 md:order-none py-8 md:h-auto" style={{
        ...
        <div className="max-w-md mx-auto">
          ...
          <p className="text-white/90 mb-8 leading-relaxed font-normal hidden md:block text-[19px]">Secure your transactions through robust identity verification, bank account validation, and insurance protection.</p>
