    ...
    <div className="min-h-screen bg-light-gray flex flex-col md:flex-row">
      ...
      <div className="flex-1 p-6 md:p-12 flex flex-col justify-center text-white relative order-1 md:order-none" style={{
        ...
        <div className="max-w-md mx-auto">
          <img src="/lovable-uploads/0df6207d-c067-4c95-b089-f3b6b2bb1c42.png" alt="BaseFund" className="h-8 mb-8 mx-auto md:mx-0" />
          
          <h2 className="text-[42px] font-black mb-6 leading-tight text-center md:text-left">
